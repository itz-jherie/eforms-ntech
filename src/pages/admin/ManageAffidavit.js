...
const ManageAffidavit = () => {
    ...
    return (
        <div className="manage-affidavit">
            <div className="mobile-manage-affidavit">
                <section className='hamburger'>
                    <AdminHamburger title="Affidavit Management" />
                </section>
                <section className='mobile-affidavit-content'>
                    <section className='mobile-affidavit-details'>
