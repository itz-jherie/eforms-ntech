...
const Basicinfo = ({register, errors}) => {
  ...
  const selectLocalGov = localGov.lgas;
  
    let lGovt=[];

    if (value != "") {

      localGov.forEach((local, index, array) => {
  ...
  const localGovElement = lGovt.map((local, index) => {
...
<div className="box2">
  ...
  {errors.states ? (
            <span className="text-red">{errors.states.message}</span>
          ) : (
            <></>
          )}
  </div>
  ...
  {errors.localGovt ? (
            <span className="text-red">{errors.localGovt.message}</span>
          ) : (
            <></>
          )}
  </div>
...
<div className="box">
  ...
  />
  {errors.zipCode ? (
            <span className="text-red">{errors.zipCode.message}</span>
          ) : (
            <></>
          )}
</div>

{/* <button onClick={next} className="btn--save">save and continue</button> */}
</div>
  )
}
