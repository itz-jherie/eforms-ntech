...
const NewAffidavit = () => {
    return (
        <div className="new-affidavit">
            <div className="mobile-new-affidavit">
                <header>
                    <AdminHamburger title="Create New Affidavit" />
                </header>
                <section className='mobile-new-affidavit-content'>
                    <section className='mobile-new-affidavit-form'>
                        <form>
                            ...
                            <button className='mobile-new-affidavit-button'>Create Affidavit</button>
                        </form>
                    </section>
                </section>
            </div>
