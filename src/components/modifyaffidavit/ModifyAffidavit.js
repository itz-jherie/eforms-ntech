...
const ModifyAffidavit = () => {
    return (
        <div className="modify-affidavit">
            <div className="mobile-modify-affidavit">
                <header>
                    <AdminHamburger title="Modify Affidavit" />
                </header>
                <section className='mobile-modify-affidavit-content'>
                    <section className='mobile-modify-affidavit-form'>
                        <form>
                            ...
                            <label htmlFor="court logo"  style={{marginBottom: '30px'}}>
                                <b>Court Logo</b>
                                <div className='mobile-affidavit-file-button'>
                            ...
                            <button className='mobile-modify-affidavit-button'>Modify Affidavit</button>
                        </form>
                    </section>
                </section>
            </div>
